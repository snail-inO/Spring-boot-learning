...
import static com.example.reactandspringdatarest.WebSocketConfiguration.MESSAGE_PREFIX;
...
public class EventHandler {
    ...
    public void newEmployee(Employee employee) {
        ...
        log.info("new employee, path: {}",getPath(employee));
    }
